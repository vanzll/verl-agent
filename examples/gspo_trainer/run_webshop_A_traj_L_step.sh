...
<<<<<<<< HEAD:examples/gspo_trainer/run_webshop_A_traj_L_step.sh
    trainer.experiment_name='gspo_qwen2.5_1.5b_A_traj_L_Step_30envsteps' \
    trainer.n_gpus_per_node=2 \
========
    trainer.experiment_name='gspo_qwen2.5_1.5b_A_Step_L_Step_30envsteps' \
    trainer.n_gpus_per_node=4 \
>>>>>>>> 3861f234c1c1bf60c5703e88e651805c55b2ed55:examples/gspo_trainer/run_webshop_A_Step_L_Step.sh
    trainer.nnodes=1 \
    trainer.save_freq=-1 \
    trainer.test_freq=5 \
