...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='grpo_qwen3_4b_A_step_L_token_8k_response_4bsz_1tp' \
    ...
    trainer.resume_from_path=/home/users/astar/cfar/yux/scratch/zhenglin/verl-agent/checkpoints/verl_agent_math/grpo_qwen3_4b_A_step_L_token_8k_response_4bsz_1tp/global_step_1500
